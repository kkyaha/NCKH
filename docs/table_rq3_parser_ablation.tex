...
Rates are mean over 1 independent repeat(s). Backend: LIVE\_gemini-flash-lite-latest.}
...
\midrule
Unguarded\_ZeroShot\_LLM & 38.00% & 90.00% & 100.00% & 272.30% & 80.00% & 914.28 ms \\
Unguarded\_FewShot\_LLM & 14.00% & 2.00% & 82.00% & 38.30% & 60.00% & 873.20 ms \\
Rule\_Only & 0.00% & 0.00% & 0.00% & 2.80% & 0.00% & 0.36 ms \\
\textbf{Guarded\_Hybrid\_Parser (Ours)} & \textbf{0.00%} & \textbf{0.00%} & \textbf{0.00%} & \textbf{2.00%} & \textbf{0.00%} & \textbf{835.34 ms} \\
\bottomrule

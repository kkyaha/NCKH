...
def run_full_suite():
    ...
    print("\n[BƯỚC 2/5] Đang mô phỏng trên Global 28-Node DAG (Tiếng Việt & Flash Sale +150% WL)...")
    ...
    print("\n[BƯỚC 3/5] Đang kiểm thử can thiệp do() liên dịch vụ trên 14 Node (7 Workload + 7 CPU)...")
